...
#Parties
label0 = Label(master, text = 'Lion A', relief = 'groove', width = 40)
label1 = Label(master, text = 'Lion B', relief = 'groove', width = 40)
Party_A = Entry(master, relief = 'groove', width = 40)
Party_B = Entry(master, relief = 'groove', width = 40)

#Consideration
label2 = Label(master, text = 'Lion A Consideration', relief = 'groove', width = 40)
label3 = Label(master, text = 'Lion B Consideration', relief = 'groove', width = 40)
